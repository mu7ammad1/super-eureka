...
interface TextToImageProps {
  initialPrompt?: string; // نص افتراضي من العقدة
}

export default function TextToImageComponent({ initialPrompt = "" }: TextToImageProps) {
  ...
  // تحديث النص الافتراضي عند تغيير initialPrompt
  useEffect(() => {
